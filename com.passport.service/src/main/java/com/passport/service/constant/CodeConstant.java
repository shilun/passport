...
public class CodeConstant {
    ...
    public static final String FIND_USER_FAIL = "find user fail";
    public static final String MOBILE_EXIST = "mobile exist";
    public static final String REG_FAIL = "reg fail";
}
