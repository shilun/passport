...
export class AdminPassComponent extends AbstractController implements OnInit {


  constructor(fm: FormBuilder, protected baseService: AdminService, protected roleService: RoleService, protected globalService: GlobalService, route: ActivatedRoute, router: Router) {
